...
const Fluxathon = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-[#0052D4] via-[#1e3a8a] to-[#1e293b]">
      ...
      <div className="max-w-6xl w-full space-y-8 md:space-y-12 relative z-10 py-8">
        {/* Logo */}
        ...
        {/* Registration Closed Notice - Smaller Version */}
        <div className="px-4">
          <Card className="p-4 sm:p-6 text-center space-y-3 bg-white/5 border border-white/10 backdrop-blur-md">
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 bg-destructive/10 rounded-full flex items-center justify-center">
                <Users className="w-5 h-5 text-destructive" />
              </div>
              <h2 className="text-lg sm:text-xl font-bold text-foreground">Registration Closed</h2>
            </div>
            <p className="text-xs sm:text-sm text-white/80 leading-relaxed">
              We've reached the maximum of {MAX_SUBMISSIONS} team submissions. Thank you for your interest!
            </p>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 px-4">
          {/* Thursday Card */}
          <Card className="p-6 bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-all duration-300 flex flex-col">
            ...
            <div className="flex items-center gap-2 text-white/60 text-sm mt-auto" style={{ fontFamily: 'Roboto Mono, monospace' }}>
